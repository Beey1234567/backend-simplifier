export interface PackageWrapper {
     ...
     */
    Query(res: Response | null | undefined, sqlConnection: Stream.Duplex | null | undefined, sql: string, FailErrorMessage: string, FailResStatus: number, SuccessMessage: string, SuccessResStatus: number, ...SqlParams: any[]): Response | void,
    /**
